pipeline {
    ...
    stages {
        ...
        stage('deployjenkins') { 
            steps { 
                sh 'kubectl apply -f https://raw.githubusercontent.com/Aldo-Montenegro/ctt-devops-eks/main/jenkins.yaml'
            }
        }
        stage('deploynexus') { 
            steps { 
                sh 'kubectl apply -f https://raw.githubusercontent.com/Aldo-Montenegro/ctt-devops-eks/main/nexus-repository.yaml'
            }
        }
        stage('deploygitlab') { 
            steps { 
                sh 'kubectl apply -f https://raw.githubusercontent.com/Aldo-Montenegro/ctt-devops-eks/main/gitlab.yaml'
            }
        }
        stage('configureingress') { 
           steps {
                ...
                sh 'kubectl apply -f https://raw.githubusercontent.com/Aldo-Montenegro/ctt-devops-eks/main/ingresses-jenkins.yaml'
                sh 'kubectl apply -f https://raw.githubusercontent.com/Aldo-Montenegro/ctt-devops-eks/main/ingresses-nexus.yaml'
                sh 'kubectl apply -f https://raw.githubusercontent.com/Aldo-Montenegro/ctt-devops-eks/main/ingresses-gitlab.yaml'
                sh 'wget https://raw.githubusercontent.com/Aldo-Montenegro/ctt-devops-eks/main/ingress-nginx-nexus-patch.yaml && kubectl patch deployment/ingress2-ingress-nginx-controller -n ingress-nginx-nexus --patch-file ingress-nginx-nexus-patch.yaml'
                sh 'wget https://raw.githubusercontent.com/Aldo-Montenegro/ctt-devops-eks/main/ingress-nginx-gitlab-patch.yaml && kubectl patch deployment/ingress3-ingress-nginx-controller -n ingress-nginx-gitlab --patch-file ingress-nginx-gitlab-patch.yaml'
            }
        }
    }
    post {
